...
export default function DelhiHighCourtEasy() {
  ...
  function handlePassageClick(passageNo: number) {
    if (passageNo === 1) {
      // Free passage - instructions page will be connected later
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-10">
          ...
          <h1 className="mt-4 text-3xl font-extrabold text-slate-900">
            Delhi High Court — Easy Practice
          </h1>

          <p className="mt-2 max-w-2xl text-slate-600">
            Select a passage below to start your Delhi High Court
            typing practice.
          </p>
        </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-emerald-800">
                Try one complete practice test for free.
                Other passages require an active subscription.
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="pr-10 text-center">
                ...
                <p className="mx-auto mt-3 max-w-xl text-slate-600">
                  This passage is available with a StenoChecker
                  typing practice subscription.
                </p>
              </div>
