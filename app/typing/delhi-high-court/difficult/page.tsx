...
export default function DelhiHighCourtDifficult() {
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-10">
          ...
          <h1 className="mt-4 text-3xl font-extrabold text-slate-900">
            Delhi High Court — Difficult Practice
          </h1>

          <p className="mt-2 max-w-2xl text-slate-600">
            Challenge yourself with advanced typing passages and
            improve your speed, accuracy and consistency.
          </p>
        </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-emerald-800">
                Try one complete difficult-level typing test
                for free. Other passages require an active
                subscription.
              </p>
            </div>
          </div>
            ...
            >
              ...
              <div className="pr-10 text-center">
                ...
                <p className="mx-auto mt-3 max-w-xl text-slate-600">
                  This difficult passage is available with a
                  StenoChecker typing practice subscription.
                </p>
              </div>
